...
<script type="text/javascript">
	...
	function myQnaDetailDelete_S(qna_num){
		alert('qna_num->'+qna_num);
		if(confirm('삭제하시겠습니까?')){
			$.ajax({
				url: '/myQnaDetailDelete_S',
				type: 'POST',
				data: {qna_num : qna_num}, 
				success: function(response){
					alert('삭제되었습니다.');
					window.location.href='/view_ms/myQna_S';
				},
	...
	<div class="container">
		<div class="content_container">
			...
			<button type="button"  style= "background:none; border: none;">
				<img alt="" src="../images/main/삭제_but.png" onclick="myQnaDetailDelete_S('${Qna.qna_num}')"
