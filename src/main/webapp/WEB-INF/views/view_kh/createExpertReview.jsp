...
<script type="text/javascript">	
	...
	function commitReview() {
		...
		$("#expertReviewInformation").attr("action", "/KH/pay/insertExpertReview").submit();
...
<body>
	...
	<form action="/KH/pay/insertExpertReview"	id="expertReviewInformation"	name="expertReviewInformation"	method="post">	
		...
		<div id="expertReviewContentDiv">
			<textarea name="content" id="expertReviewContent"	maxlength="1000"></textarea>
			<br>
