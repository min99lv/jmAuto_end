...
<nav class="nav__cont">
  ...
  <ul class="nav">
    <li class="nav__items">
      ...
      <a href="/view_ms/buyList" class="nav_items_text">구매내역</a>
    </li>
      
    <li class="nav__items">
      <img alt="icon" src="../images/main/찜_icon.png" class="nav_items_img">
     <a href="/view_ms/myZzim" class="nav_items_text">관심목록</a>
    </li>
      
    <li class="nav__items">
      <img alt="icon" src="../images/main/구매한리뷰.png" class="nav_items_img">
      <a href="/view_ms/reviewList" class="nav_items_text">구매한리뷰</a>
    </li>
    <li class="nav__items3">
      ...
      <div class="mon_nav_items">
      	<a href="/view_ms/myNote">차량구매 문의 내역</a>
      	<a href="/view_ms/myQna">고객센터 문의 내역</a>
      </div>
    </li>
    <li class="nav__items">
    ...
    <li class="nav__items2">
      <a href="/view_ms/talTwae" class="nav_items_text2">회원탈퇴</a>
    </li>
  </ul>
</nav>
