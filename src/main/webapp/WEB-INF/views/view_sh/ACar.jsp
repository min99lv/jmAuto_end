...
<div id="result0">
	...
	<div class="manager_pagination">
	    ...
	    <c:if test="${page.startPage > page.pageBlock}">
	        <a id="page" class="manager_pagination_a_back" href="${pageContext.request.contextPath}/getListSearch?currentPage=${page.startPage-page.pageBlock}&total=${total}&keyword=${keyword}">&nbsp; 이전 &nbsp;</a>
	    </c:if>
	    ...
	    <c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
	    	<c:choose>
	    		...
	    		<c:otherwise>
	        		<a id="page" class="manager_pagination_a" href="${pageContext.request.contextPath}/getListSearch?currentPage=${i}&total=${total}&keyword=${keyword}">&nbsp; ${i} &nbsp;</a>
	    		</c:otherwise>
	    	</c:choose>
	    </c:forEach>
	    ...
	    <c:if test="${page.endPage < page.totalPage}">
	        <a class="manager_pagination_a_next" id="page" href="${pageContext.request.contextPath}/getListSearch?currentPage=${page.startPage+page.pageBlock}&total=${total}&keyword=${keyword}">&nbsp; 다음 &nbsp;</a>
	    </c:if>
	</div>
